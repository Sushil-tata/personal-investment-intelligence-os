...
FIXTURES = {
    ...
    "/recommendations/generate": {
        ...
        "portfolio_observations": [
            {"code": "INDIA_CONCENTRATION", "severity": "HIGH", "detail": "India sleeve dominates."}
        ],
        "recommendations": [
            {
                "action": "BUY",
                ...
                "current_value": 0.0,
                "current_weight": 0.0,
                "proposed_allocation": 1700.0,
                "proposed_total_value": 1700.0,
                "post_weight": 0.1,
                "score": 78.0,
                "confidence": 0.64,
                "market_data_provider": "development_seed",
                ...
                "seeded_input": True,
                "rationale": "Diversify",
                "diversification_contribution": "Adds ex-US exposure.",
                "risks": ["Seeded input"],
                "unavailable_inputs": [],
                "conditions_to_change": ["Re-run next month"],
                "components": [],
                "evidence": [],
            },
            {
                "action": "BUY",
                "ticker": "BND",
                "instrument_name": "Vanguard Total Bond Market ETF",
                "portfolio_role": "Stability Sleeve",
                "current_value": 0.0,
                "current_weight": 0.0,
                "proposed_allocation": 1500.0,
                "proposed_total_value": 1500.0,
                "post_weight": 0.09,
                "score": 72.0,
                "confidence": 0.6,
                "market_data_provider": "development_seed",
                ...
                "seeded_input": True,
                "rationale": "Stability",
                "diversification_contribution": "Defensive ballast.",
                "risks": ["Rate risk"],
                "unavailable_inputs": [],
                "conditions_to_change": ["Rates shift"],
                "components": [],
                "evidence": [],
            },
            {
                ...
                "current_weight": 0.03,
                "proposed_allocation": 1800.0,
                "proposed_total_value": 10800.0,
                "post_weight": 0.12,
                "score": 74.0,
                "confidence": 0.58,
                "market_data_provider": "development_seed",
                ...
                "diversification_contribution": "Moderate",
                "risks": ["Tech concentration"],
                "unavailable_inputs": [],
                "conditions_to_change": ["Concentration exceeds limits"],
                "components": [],
                "evidence": [],
            },
        ],
        "assumptions": ["Long-term horizon"],
...
PAGES = [
    ...
    "pages/28_Investment_Recommendations.py",
]
